...
public class VacuumIntakeCMD extends CommandBase {
    ...
    public VacuumIntakeCMD(VacuumSubsystem vacuumSubsystem, CRServo vacuumPeriodicServo,
    ...
    @Override
    public  void execute(){
        m_vacuumSubsystem.powerVacuum(m_vacuumPeriodicServo,1);
    }
